...
initial_path = "C:\\Users\\wilhe\\Dropbox\\My PC (DESKTOP-P6322LG)\\Desktop\\Final Training Work\\Raw Training Data\\Subsea Classifier\\TrainingData.csv"
...
training_path = "C:\\Users\\wilhe\\Dropbox\\My PC (DESKTOP-P6322LG)\\Desktop\\Final Training Work\\Test Train Storage\\Subsea Classifier\\training_set.csv"
test_path = "C:\\Users\\wilhe\\Dropbox\\My PC (DESKTOP-P6322LG)\\Desktop\\Final Training Work\\Test Train Storage\\Subsea Classifier\\test_set.csv"
...
for q in range(0, 2):
    model.add(layers.Dense(2, tf.nn.silu))

# Add a dense output layer of neurons
#model.add(layers.Dense(1))
model.add(layers.Dense(1, 'sigmoid'))
                
model.compile(optimizer=keras.optimizers.Adam(learning_rate = 1e-1), loss = 'binary_crossentropy', metrics = ['accuracy', 'AUC', 'binary_accuracy'])
